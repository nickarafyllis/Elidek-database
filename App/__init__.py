...
app.config["MYSQL_DB"] = 'HFRIManagement'
app.config["MYSQL_HOST"] = 'localhost'
app.config["SECRET_KEY"] = 'clone' ## secret key for sessions (signed cookies). Flask uses it to protect the contents of the user session against tampering.
